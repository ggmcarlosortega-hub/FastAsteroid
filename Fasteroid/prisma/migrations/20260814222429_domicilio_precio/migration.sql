/*
  ...
  - Added the required column `precio` to the `domicilio` table without a default value. This is not possible if the table is not empty.
...
-- Backfill: filas existentes (todas de pruebas de desarrollo) heredan como
-- `precio` lo que ya tenían en `valor_recaudado`, o 0 si nunca se cobró nada.
INSERT INTO "new_domicilio" ("distancia_km", "espacio_baul", "estado", "fecha_hora_creacion", "fecha_hora_entrega", "foto_productos_url", "id_domicilio", "id_ubicacion", "metodo_pago", "motivo_cancelacion", "productos", "precio", "telefono_cliente", "telefono_domiciliario", "valor_recaudado") SELECT "distancia_km", "espacio_baul", "estado", "fecha_hora_creacion", "fecha_hora_entrega", "foto_productos_url", "id_domicilio", "id_ubicacion", "metodo_pago", "motivo_cancelacion", "productos", COALESCE("valor_recaudado", 0), "telefono_cliente", "telefono_domiciliario", "valor_recaudado" FROM "domicilio";
